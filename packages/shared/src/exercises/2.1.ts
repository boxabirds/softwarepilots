    ...
    steps: [
      {
        ...
        context: ["predict", "output", "print", "what will happen"],
      },
      {
        type: "experiment",
        prompt: "Now try removing `str()` from line 3 and run again. What happens?",
        context: ["removing", "str function", "error", "experiment", "try"],
      },
      {
        ...
        context: ["edit", "change", "modify", "predict modified code"],
      },
      {
        type: "reflect",
        ...
        context: ["reflect", "learned", "changed", "understanding"],
      },
    ],
  },
  rubric: {
